...
export default function TeamPage() {
  ...
  return (
    <div className="flex-1 bg-bg-secondary p-8 p-8 pb-12" style={{ minHeight: 'calc(100vh - 56px)' }}>
      {/* ── Header ── */}
      <div className="mb-8">
            ...
            return (
              <div key={p.id} className="bg-bg-primary border border-border-light rounded-xl overflow-hidden transition-all hover:shadow-md hover:-translate-y-0.5 relative">
                ...
                <div className="p-5 pb-4 flex items-start gap-3.5">
                  <div
                    className="w-13 h-13 rounded-3.5 flex items-center justify-center text-[15px] font-bold text-white tracking-wide flex-shrink-0"
                ...
                {/* Actions */}
                <div className="p-0 px-5 pb-5 flex gap-2">
                  <a
                    href={`tel:${p.phone}`}
